...
import { TankLevelMonitoringTable } from "@/components/tables/tank-level-monitoring";
import { LeakAnomalyDetectionTable } from "@/components/tables/leak-detection-table";
import DeviceOverviewTable from "@/components/tables/water-overview-table";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
       ...
       <div className="w-full flex-1">
         <EquipmentCard type="water" />
       </div>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="flex flex-col space-y-4">
          <TankLevelMonitoringTable />
          <LeakAnomalyDetectionTable />
        </div>
        <div className="flex flex-col space-y-4">
          {/* <PanelTable /> */}
          {/* <PanelAssetsTable /> */}
